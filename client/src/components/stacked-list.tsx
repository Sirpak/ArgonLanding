  ...
  return (
    <section className="py-16 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Inspirational Quotes near Our Process */}
        <div className="mb-16 grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {/* Quote 1 */}
          <div className="glass-card p-6 rounded-2xl border-2 border-purple-500/30 bg-purple-600/10 hover:bg-purple-600/20 transition-all duration-300 group">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="text-lg font-semibold text-purple-400">Partnership</h4>
            </div>
          ...
          {/* Quote 2 */}
          <div className="glass-card p-6 rounded-2xl border-2 border-orange-500/30 bg-orange-600/10 hover:bg-orange-600/20 transition-all duration-300 group">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h4 className="text-lg font-semibold text-orange-400">Expertise</h4>
            </div>
            <blockquote className="text-slate-200 leading-relaxed font-medium italic text-lg">
