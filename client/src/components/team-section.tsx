    ...
    <section id="team" className="py-24 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-4 gap-8 items-start">
          ...
          {/* Covemind Team Image - Right Side */}
          <div className="lg:col-span-1 flex justify-center lg:justify-end">
            <div className="glass-card p-6 rounded-2xl border-2 border-gradient-to-br from-blue-500 to-emerald-500 bg-gradient-to-r from-blue-600/10 to-emerald-600/10 backdrop-blur-sm">
              <img 
                src="/covermind_team.png" 
                alt="Covemind Team" 
                className="w-full h-auto max-w-xs rounded-xl object-contain"
              />
              <div className="mt-4 text-center">
                <h4 className="text-lg font-semibold text-blue-400 mb-2">Our Team</h4>
                <p className="text-sm text-slate-300">Working together to automate your success</p>
              </div>
            </div>
          </div>
        </div>
