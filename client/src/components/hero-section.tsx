        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
            ...
            <button
              ...
              className="glass-card text-white px-8 py-4 rounded-xl font-semibold text-xl hover:bg-slate-700/60 transition-all duration-300 border border-slate-600/50"
            >
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 text-slate-400">
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg">We'll put your business operations on autopilot — so your workload is reduced</span>
            </div>
            <div className="flex items-center gap-2">
              <ShieldCheck className="w-6 h-6 text-green-500" />
              <span className="text-lg">We build the workflow for you</span>
